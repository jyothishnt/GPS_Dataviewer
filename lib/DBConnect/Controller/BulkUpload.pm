        ...
        my $q = qq{
          ...
          VALUES ("$lane", $rowString)
            ON DUPLICATE KEY UPDATE
              ...
              gra_cmx_1_U85507 = $row->[25],
              gra_dfrA12_1_AB571791 = $row->[26],
              gra_dfrA14_1_DQ388123 = $row->[27],
              gra_dfrC_1_GU565967 = $row->[28],
              gra_dfrC_1_Z48233 = $row->[29],
              gra_dfrG_1_AB205645 = $row->[30],
              gra_ermA_2_AF002716 = $row->[31],
              gra_ermB_10_U86375 = $row->[32],
              gra_ermB_16_X82819 = $row->[33],
              gra_ermB_18_X66468 = $row->[34],
              gra_ermB_20_AF109075 = $row->[35],
              gra_ermB_6_AF242872 = $row->[36],
              gra_ermC_13_M13761 = $row->[37],
              gra_fexA_1_AJ549214 = $row->[38],
              gra_fosA_8_ACHE01000077 = $row->[39],
              gra_fosB_1_X54227 = $row->[40],
              gra_fusA_17_DQ866810 = $row->[41],
              gra_fusB_1_AM292600 = $row->[42],
              gra_fusD_AP008934 = $row->[43],
              gra_ileS2_GU237136 = $row->[44],
              gra_lnuA_1_M14039 = $row->[45],
              gra_lsaC_1_HM990671 = $row->[46],
              gra_mecA_10_AB512767 = $row->[47],
              gra_mecA_15_AB505628 = $row->[48],
              gra_mefA_10_AF376746 = $row->[49],
              gra_mefA_3_AF227521 = $row->[50],
              gra_mefE_AE007317 = $row->[51],
              gra_merA_L29436 = $row->[52],
              gra_merB_L29436 = $row->[53],
              gra_merR_L29436 = $row->[54],
              gra_mphA_1_D16251 = $row->[55],
              gra_mphB_1_D85892 = $row->[56],
              gra_mphC_2_AF167161 = $row->[57],
              gra_msrA_1_X52085 = $row->[58],
              gra_msrC_2_AF313494 = $row->[59],
              gra_msrD_2_AF274302 = $row->[60],
              gra_msrD_3_AF227520 = $row->[61],
              gra_qacA_AP0003367 = $row->[62],
              gra_qepA_1_AB263754 = $row->[63],
              gra_smr_qacC_M37889 = $row->[64],
              gra_strA_1_M96392 = $row->[65],
              gra_strA_4_NC_003384 = $row->[66],
              gra_strB_1_M96392 = $row->[67],
              gra_str_1_X92946 = $row->[68],
              gra_str_2_FN435330 = $row->[69],
              gra_sul1_1_AY224185 = $row->[70],
              gra_sul1_9_AY963803 = $row->[71],
              gra_sul2_9_FJ197818 = $row->[72],
              gra_tet32_2_EF626943 = $row->[73],
              gra_tet38_3_FR821779 = $row->[74],
              gra_tetB_4_AF326777 = $row->[75],
              gra_tetG_4_AF133140 = $row->[76],
              gra_tetK_4_U38428 = $row->[77],
              gra_tetL_2_M29725 = $row->[78],
              gra_tetL_6_X08034 = $row->[79],
              gra_tetM_10_EU182585 = $row->[80],
              gra_tetM_12_FR671418 = $row->[81],
              gra_tetM_13_AM990992 = $row->[82],
              gra_tetM_1_X92947 = $row->[83],
              gra_tetM_2_X90939 = $row->[84],
              gra_tetM_4_X75073 = $row->[85],
              gra_tetM_5_U58985 = $row->[86],
              gra_tetM_6_M21136 = $row->[87],
              gra_tetM_8_X04388 = $row->[88],
              gra_tetO_1_M18896 = $row->[89],
