...
editable_columns = ['grs_comments', 'grs_in_silico_st', 'grs_in_silico_serotype', 'grs_vaccine_status', 'grs_vaccine_period'];
var visible_columns = new Array();
visible_columns = ['gss_lane_id', 'gss_public_name', 'grs_in_silico_st', 'grs_in_silico_serotype', 'grs_gps_qc', 'grs_comments' ];
...
$("select[name='st_update_type']").change( function() {
  ...
  if (selectVal === "CLSI") {
    str = 'Input file must contain the <br> <span class="red">Lane ID</span> column followed by <span class="red"> CLSI columns </span>'+
          'in the following order <br> <div class="bulk-upload-column-display blue"> penicillin_CLSI amoxicillin_CLSI cefotaxine_CLSI ceftriaxone_CLSI cefuroxime_CLSI meropenem_CLSI erythromycin_CLSI clindamycin_CLSI trim_sulfa_CLSI vancomycin_CLSI linezolid_CLSI ciprofloxacin_CLSI chloramphenicol_CLSI tetracycline_CLSI levofloxacin_CLSI synercid_CLSI rifampin_CLSI </div>';
  }
